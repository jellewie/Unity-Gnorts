...
{
    public Camera TheCamera;           //the camera that needs to make the screenshot
    ...
    private string UniqueFilename(int width, int height)
    {
        ...
        if (folder == null || folder.Length == 0)
        {
            ...
            folder += "/Assets/Screenshots";                                                //Set the directory
    ...
    void Update()
    {
        ...
        if (captureScreenshot)
        {
            ...
            if (renderTexture == null)
            {
                ...
                renderTexture = new RenderTexture(captureWidth, captureHeight, 16);
