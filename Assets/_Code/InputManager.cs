...
public class InputManager : MonoBehaviour
{
    ...
    private void InitaliseBuildingCost()                                                //Init the bool settings (set default values)
    {
        ...
        BuildingCostArray[5]  = new Building("Fire_Basket",             0,  0,  0,  10, false,	BuildType.FireBasket,  0,  0);
    ...
    public Building GetInfo(String ItemName)                                            //Get building information about a building
    {
        ...
        Debug.LogWarning("InputManager::GetInfo -- No object named: '" + ItemName + "' in the BuildingCostArray");  //Log error, object not found
        return new Building("N/A", 0, 0, 0, 0, false, 0, 0, 0);                         //Just give something 'random' back
    }
}
