...
namespace PublicCode {
    public static class JelleWho {
        ...
        public static float RotateSpeedKeyboard = 1;                                            //The speed of the rotation when keyboard is used for rotation

        public static float MoveEdgeScrollSpeed = 1.5f / 0.016f;                                //The speed of the screen when moving with the screen edges
        public static float MoveSpeedMouse = 1f / 0.016f;                                       //The speed of dragging the map with the mouse
        public static float MoveSpeedKeyboard = 0.7f / 0.016f;                                  //The speed of dragging the map with the keyboard
        
        
        public static float MinCameraHeight = 1;                                                //The min height the camera needs to be
        public static float MaxCameraHeight = 128;                                              //The max heigh the camera can go
        public static float MaxMoveHorizontalOnMap = 128;                                       //The max distance the camera can be moved away from the center
        public static float ZoomScrollWheelSpeed = 25;                                          //The speed of dthe ScrollWheel when zooming in and out
