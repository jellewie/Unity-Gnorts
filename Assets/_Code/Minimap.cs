...
public class Minimap : MonoBehaviour {
    ...
    void LateUpdate() {
        ...
        if (EnableZoom)
        {
            ...
            {
                float O = FollowCam.orthographicSize * ScrollWheelChange * JelleWho.MinimapScrollSpeed;
                FollowCam.orthographicSize = Mathf.Clamp(FollowCam.orthographicSize - O, 10, JelleWho.MaxCameraHeight * 3);
            }
        }
    }
